...
const homewhychoosemodel = require('../../../../../shadicenter/server/app/model/adminmodel/HomeWhyChooseModel')
const homefeaturedprofilemodel = require('../../../../../shadicenter/server/app/model/adminmodel/HomeFeaturedProfileModel')
const homesuccessstoriesmodel = require('../../../../../shadicenter/server/app/model/adminmodel/HomeSuccessStoriesmodel')
...
//                     Sub_id: "1",
//                     Success_Stories_Card_Image: req.files[0].filename,
//                     Success_Stories_Card_Section_Name_Text_Bold: viewdata[0].Success_Stories_Card_Section_Name_Text_Bold,
//                     Success_Stories_Card_Section_Name_Font_Size: viewdata[0].Success_Stories_Card_Section_Name_Font_Size,
//                     Success_Stories_Card_Section_Name_Text_Align: viewdata[0].Success_Stories_Card_Section_Name_Text_Align,
//                     Success_Stories_Card_Section_Name_Text_Decoration: viewdata[0].Success_Stories_Card_Section_Name_Text_Decoration,
//                     Success_Stories_Card_Section_Home_Name_Color: viewdata[0].Success_Stories_Card_Section_Home_Name_Color,
//                     Success_Stories_Card_Section_Name_Text_Line: viewdata[0].Success_Stories_Card_Section_Name_Text_Line,
//                     Success_Stories_Card_Section_Name_Heading: req.body.Success_Stories_Card_Section_Name_Heading,

//                     Success_Stories_Marriage_Date_Text_Bold: viewdata[0].Success_Stories_Marriage_Date_Text_Bold,
//                     Success_Stories_Marriage_Date_Font_Size: viewdata[0].Success_Stories_Marriage_Date_Font_Size,
//                     Success_Stories_Marriage_Date_Text_Align: viewdata[0].Success_Stories_Marriage_Date_Text_Align,
//                     Success_Stories_Marriage_Date_Text_Decoration: viewdata[0].Success_Stories_Marriage_Date_Text_Decoration,
//                     Success_Stories_Marriage_Date_Color: viewdata[0].Success_Stories_Marriage_Date_Color,
//                     Success_Stories_Marriage_Date_Text_Line: viewdata[0].Success_Stories_Marriage_Date_Text_Line,
//                     Success_Stories_Card_Section_Marriage_Date_Heading: req.body.Success_Stories_Card_Section_Marriage_Date_Heading,

//                     Success_Stories_Description_Text_Bold: viewdata[0].Success_Stories_Description_Text_Bold,
//                     Success_Stories_Description_Font_Size: viewdata[0].Success_Stories_Description_Font_Size,
//                     Success_Stories_Description_Text_Align: viewdata[0].Success_Stories_Description_Text_Align,
//                     Success_Stories_Description_Text_Decoration: viewdata[0].Success_Stories_Description_Text_Decoration,
//                     Success_Stories_Description_Color: viewdata[0].Success_Stories_Description_Color,
//                     Success_Stories_Description_Text_Line: viewdata[0].Success_Stories_Description_Text_Line,
//                     Success_Stories_Card_Section_Description_Heading: req.body.Success_Stories_Card_Section_Description_Heading
//                 }
//                 let insertdata = await homesuccessstoriesmodel(data)
//                 insertdata.save()
