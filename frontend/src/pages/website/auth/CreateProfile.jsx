...
export function CreateProfile() {
    ...
    let formik = useFormik({
        ...
        validationSchema: Yup.object().shape({
            ...
            About_Myself: Yup.string().required("About Myself is required"),
    ...
    let insertdata = (values) => {
        try {
            api.post('/create-profile', toFormData(values), {
                headers: {
                    Authorization: token
                }
            })
                .then((res) => {
                    if (res.data.Status === 1) {
                        ...
                        setloader(false)
                        navigate(`/professional-details/${getCookie('User_Id')}`)
                    }
                    else {
        ...
        <>
            {
                loader ? <Loader /> :
                    ...
                    >
                        <section className='login_form w-[550px] h-[90vh] overflow-y-scroll rounded-[30px] py-3 bg-[white] me-[30px]'>
                            <section className='flex justify-center'>
                                <img src={logo} alt="" className='w-[220px] mt-2' />
                            </section>

                            <section className='text-center my-[15px]'>
                                <h1 className='text-[40px] italic font-[600]' style={{ fontFamily: "Cormorant Garamond" }}>Create Profile</h1>
                                <p className='text-[19px] font-[600]'>Please enter your details to create profile.</p>
                            </section>
                            ...
                            <section className='flex justify-center mt-[20px]'>
                                <form className='w-[80%]' onSubmit={formik.handleSubmit}>
                                    ...
                                    <div className='w-[100%]'>
                                        ...
                                        <select
                                            type="text"
                                            className='w-[100%] p-2 py-[10px] rounded-[10px] mt-[3px] border-[1px] bg-[#EAE8E8] outline-none'
                                    ...
                                    <div className='w-[100%]'>
                                        <label>About Myself<sup className='text-[red]'>*</sup></label>
                                        <textarea
                                            type='text'
                                            className='w-[100%] p-2 py-[10px] rounded-[10px] mt-[3px] border-[1px] bg-[#EAE8E8] outline-none'
                                            onChange={(e) => formik.setFieldValue('About_Myself', e.target.value)}
                                        />
                                        <div className='mb-[10px] mt-[1px] text-[red]'>{formik.errors.About_Myself}</div>
                                    </div>
                                    ...
                                    <button type='submit' className='w-[100%] p-[10.5px] rounded-[8px]' style={{ backgroundColor: "#FF83D4", color: "#FFFF" }}>Create Profile</button>
