                        ...
                        <section className='w-[100%] h-[calc(100vh-97px)]  flex justify-between'>
                            ...
                            <section className='w-[calc(100%-250px)] h-[100%] overflow-y-scroll bg-[#deeff6] p-3'>
                                ...
                                <section className='form_shadow mt-[20px] w-[100%] p-2 bg-[white] rounded-[8px]'>
                                    <p className='text-[15px]'>ADD RELIGIONS</p>
                                    ...
                                    <form onSubmit={formik.handleSubmit}>
                                        <section className='w-[100%] flex justify-between border-[1px] my-[20px]'>
                                            <section className='w-[48%]'>
                                                ...
                                                <input type="text" className='border-[1px] border-[black] w-[100%] rounded-[5px] p-[5px]' onChange={(e) => formik.setFieldValue('Religion_Name', e.target.value)} />
                                            </section>
                                ...
                                <section className='form_shadow mt-[20px] w-[100%] p-2 bg-[white] rounded-[8px]'>
                                    <p className='text-[15px]'>View Religions</p>
                                        ...
                                        religions.length === 0 ?
                                            ...
                                            <table className='w-[100%] border-[1px] my-[20px]'>
                                                <thead className='w-[100%]'>
                                                    <tr className='w-[100%]'>
                                                        <th className='w-[30%] border-[1px]'>Religion Name</th>
                                                ...
                                                {religions.map((items, index) => {
                                                    return (
                                                        <tbody key={index}>
                                                            <tr className='w-[100%] text-center'>
                                                                <td className='w-[30%] border-[1px]'>{items.Religion_Name}</td>
                                                                ...
                                                                <td className='w-[20%] border-[1px]'>
                                                                    <Link to={`/dash-update-religions/${items._id}/${items.Religion_Name}/${items.Status}`} className='bg-[skyblue] py-2 px-4 rounded-[10px] text-white my-2'>
                                                                        Update
                                                                    </Link>
                                                                </td>
                                                                <td className='w-[20%] border-[1px]'>
