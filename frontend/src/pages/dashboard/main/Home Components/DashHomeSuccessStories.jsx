...
export function DashHomeSuccessStories() {
    ...
    let formik = useFormik({
        ...
        initialValues: {
            ...
            Success_Stories_Card_Section_Name_Text_Bold: "400" || "",
            Success_Stories_Card_Section_Name_Font_Size: "20" || "",
            Success_Stories_Card_Section_Name_Text_Align: aligntext[0],
            Success_Stories_Card_Section_Name_Text_Decoration: "none" || "",
            Success_Stories_Card_Section_Home_Name_Color: "#FF0000" || "",
            Success_Stories_Card_Section_Name_Text_Line: "30" || "",
            Success_Stories_Card_Section_Name_Heading: "",

            Success_Stories_Marriage_Date_Text_Bold: "300" || "",
            Success_Stories_Marriage_Date_Font_Size: "20" || "",
            Success_Stories_Marriage_Date_Text_Align: aligntext[1],
            Success_Stories_Marriage_Date_Text_Decoration: "none" || "",
            Success_Stories_Marriage_Date_Color: "#252525" || "",
            Success_Stories_Marriage_Date_Text_Line: "30" || "",
            Success_Stories_Card_Section_Marriage_Date_Heading: "",


            Success_Stories_Description_Text_Bold: "400" || "",
            Success_Stories_Description_Font_Size: "20" || "",
            Success_Stories_Description_Text_Align: aligntext[2],
            Success_Stories_Description_Text_Decoration: "none" || "",
            Success_Stories_Description_Color: "#3D3D3D" || "",
            Success_Stories_Description_Text_Line: "30" || "",
    ...
    let insertdata = (value) => {
        try {
            api.post('/add-home-success', toFormData(value),{
                headers : {
    ...
    return (
        <>
            <section className='form_shadow mt-[20px] w-[100%] p-2 bg-[white] rounded-[8px]'>
                <p className='text-[15px]'>ADD SUCCESS STORIES</p>
                            ...
                            <div className='w-[100%] mt-[5px]'>
                                <div className='flex justify-between'>
                                    <div className='border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <FaBold />
                                        <select defaultValue={"500"} className='p-1 w-[100%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Name_Text_Bold', e.target.value)}>
                                            <option>bold</option>
                                    ...
                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        ...
                                        <input type='number' defaultValue={"20"} className='p-1 w-[80%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Name_Font_Size', e.target.value)} />
                                    </div>
                                    ...
                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        ...
                                        <select defaultValue={"None"} className='p-1 w-[70%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Name_Text_Decoration', e.target.value)}>
                                    ...
                                    <div className='w-[10%] border-[1px] border-[black] text-[18px] flex items-center'>
                                        <input defaultValue={"#000000"} className='p-1 w-[100%] h-[30px] outline-none' type='color' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Home_Name_Color', e.target.value)} />
                                    </div>

                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <CgFormatLineHeight className='text-[30px]' />
                                        <input type='number' defaultValue={"30"} className='p-1 w-[80%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Name_Text_Line', e.target.value)} />
                                    </div>
                                </div>
                                <textarea type="text" className='w-[100%] rounded-[5px] p-[5px] border-[1px] border-[black]' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Name_Heading', e.target.value)} />
                        ...
                        <section className='w-[48%]'>
                            ...
                            <div className='w-[100%] mt-[5px]'>
                                <div className='flex justify-between'>
                                    <div className='border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <FaBold />
                                        <select defaultValue={"700"} className='p-1 w-[100%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Marriage_Date_Text_Bold', e.target.value)}>
                                            <option>bold</option>
                                            <option value="100">100</option>
                                            <option value="200">200</option>
                                            <option value="300">300</option>
                                    ...
                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <CgFormatText className='text-[30px]' />
                                        <input type='number' defaultValue={"45"} className='p-1 w-[80%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Marriage_Date_Font_Size', e.target.value)} />
                                    </div>
                                    ...
                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <MdTextFormat className='w-[30%] text-[30px]' />
                                        <select defaultValue={"None"} className='p-1 w-[70%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Marriage_Date_Text_Decoration', e.target.value)}>
                                            <option value="None">None</option>
                                            <option value="underline">Underline</option>
                                            <option value="line-through">Upperline</option>
                                            <option value="overline">Overline</option>
                                    ...
                                    <div className='w-[10%] border-[1px] border-[black] text-[18px] flex items-center'>
                                        <input defaultValue={"#000000"} className='p-1 w-[100%] h-[30px] outline-none' type='color' onChange={(e) => formik.setFieldValue('Success_Stories_Marriage_Date_Color', e.target.value)} />
                                    </div>

                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <CgFormatLineHeight className='text-[30px]' />
                                        <input type='number' defaultValue={"40"} className='p-1 w-[80%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Marriage_Date_Text_Line', e.target.value)} />
                                    </div>
                                </div>
                                <input type="date" className='w-[100%] h-[60px] rounded-[5px] p-[5px] border-[1px] border-[black]' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Marriage_Date_Heading', e.target.value)} />
                                <div className='text-[red]'>
                        ...
                        <section className='w-[48%]'>
                            ...
                            <div className='w-[100%] mt-[5px]'>
                                <div className='flex justify-between'>
                                    <div className='border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <FaBold />
                                        <select defaultValue={"500"} className='p-1 w-[100%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Description_Text_Bold', e.target.value)}>
                                            <option>bold</option>
                                            <option value="100">100</option>
                                            <option value="200">200</option>
                                            <option value="300">300</option>
                                    ...
                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <CgFormatText className='text-[30px]' />
                                        <input type='number' defaultValue={"20"} className='p-1 w-[80%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Description_Font_Size', e.target.value)} />
                                    </div>
                                    ...
                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <MdTextFormat className='w-[30%] text-[30px]' />
                                        <select defaultValue={"None"} className='p-1 w-[70%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Description_Text_Decoration', e.target.value)}>
                                            <option value="None">None</option>
                                            <option value="underline">Underline</option>
                                            <option value="line-through">Upperline</option>
                                            <option value="overline">Overline</option>
                                    ...
                                    <div className='w-[10%] border-[1px] border-[black] text-[18px] flex items-center'>
                                        <input defaultValue={"#000000"} className='p-1 w-[100%] h-[30px] outline-none' type='color' onChange={(e) => formik.setFieldValue('Success_Stories_Description_Color', e.target.value)} />
                                    </div>

                                    <div className='w-[15%] border-[1px] ps-2 border-[black] text-[18px] flex items-center'>
                                        <CgFormatLineHeight className='text-[30px]' />
                                        <input type='number' defaultValue={"30"} className='p-1 w-[80%] outline-none' onChange={(e) => formik.setFieldValue('Success_Stories_Description_Text_Line', e.target.value)} />
                                    </div>
                                </div>
                                <textarea type="text" className='w-[100%] rounded-[5px] p-[5px] border-[1px] border-[black]' onChange={(e) => formik.setFieldValue('Success_Stories_Card_Section_Description_Heading', e.target.value)} />
                                <div className='text-[red]'>
                                    {formik.errors.Sub_Home_Heading}
                                </div>
                            </div>
