...
export function DashUpdateEducation() {


    let [loader, setloader] = useState(false);
    let { _id, EducationName, Status } = useParams();
    ...
    let updatedata = (value) => {
        try {
            api.put('/update-education', value, {
                headers: {
                                        ...
                                        <form onSubmit={formik.handleSubmit}>
                                            <section className='w-[100%] flex justify-between border-[1px] my-[20px]'>
                                                <section className='w-[48%]'>
                                                    ...
                                                    <input type="text" defaultValue={EducationName} className='border-[1px] border-[black] w-[100%] rounded-[5px] p-[5px]' onChange={(e) => formik.setFieldValue('Education_Name', e.target.value)} />
                                                </section>
